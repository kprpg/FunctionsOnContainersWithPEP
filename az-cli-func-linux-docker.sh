...
docker build --tag girishpillai/azurefunctionsimage:v1.0.2 .
## run it locally and check
docker  run -p 8080:80 -it girishpillai/azurefunctionsimage:v1.0.2
## Verify function by going to http://localhost:8080
## Push the image to docker hub
docker push girishpillai/azurefunctionsimage:v1.0.2
##### Docker END   ###################################
